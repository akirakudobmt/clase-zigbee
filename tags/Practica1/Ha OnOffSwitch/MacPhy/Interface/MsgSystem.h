...
#define MSG_Free(msg)  MSG_DebugFree(msg)
#define MSG_AllocType(type) MSG_DebugAlloc(sizeof(type))
#define MSG_Alloc(size) MSG_DebugAlloc(size)
...
#define gMaxRxTxDataLength_c (161)
#else
#define gMaxRxTxDataLength_c (147)
#endif
