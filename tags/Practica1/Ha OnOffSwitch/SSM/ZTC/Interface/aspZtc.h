...
typedef struct aspTelecTest_tag {  /* AspTelecTest  */
  uint8_t mode;
} aspTelecTest_t;

typedef struct aspTelecsetFreq_tag {  /* AspTelecSetFreq  */
  uint8_t channel;
} aspTelecsetFreq_t;
...
typedef union aspReq_tag {
  ...
  aspGetMacStateReq_t aspMsgTypeGetMacStateReq;    /*B04482 This member was missing, hence the dummy member "c"*/ 
