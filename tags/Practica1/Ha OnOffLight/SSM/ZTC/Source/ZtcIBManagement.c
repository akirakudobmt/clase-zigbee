...
*/
  ...
  {gNwkSecurityLevel_c,                     mZtcIBRO, sizeof(NlmeGetRequest(gNwkSecurityLevel_c)),            mIBScalar,           (void *) &NlmeGetRequest(gNwkSecurityLevel_c)},
  {gNwkSecurityMaterialSet_c,               mZtcIBRO, sizeof(NlmeGetRequest(gNwkSecurityMaterialSet_c)),      2,                   (void *) NlmeGetRequest(gNwkSecurityMaterialSet_c)},
  ...
  {gNwkSecureAllFrames_c,                   mZtcIBRW, sizeof(NlmeGetRequest(gNwkSecureAllFrames_c)),          mIBScalar,           (void *) &NlmeGetRequest(gNwkSecureAllFrames_c)},
