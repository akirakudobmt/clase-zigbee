...
//#define Type_RFDNBNVNS
    ...
    !defined(Type_FFDZSNBNV) && !defined(Type_FFDZSNBNVNS) && !defined(Type_FFDNBNVNS) && \
    ...
    !defined(Type_RFDZSNBNV) && !defined(Type_RFDZSNBNVNS) && !defined(Type_RFDNBNVNS)
#define Type_FFD
#endif // Type_***
...
//**********************************************************************************
  ...
  #define gTotalBigMsgs_d           8 // Number of data messages
  #define gNumAclEntryDescriptors_c 4 // Number of ACL entries in MAC PIB
#endif

#if defined(Type_RFDNBNS) || \
    defined(Type_RFDZSNVNS) || defined(Type_RFDNVNS) || defined(Type_RFDZSNBNVNS) || defined(Type_RFDNBNVNS)
  ...
  #define gNumAclEntryDescriptors_c 4 // Number of ACL entries in MAC PIB
    ...
    defined(Type_FFDZSNGTSNVNS) || defined(Type_FFDNGTSNVNS) || defined(Type_FFDZSNBNVNS) || defined(Type_FFDNBNVNS) || \
