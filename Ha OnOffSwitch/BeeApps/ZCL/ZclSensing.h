...
/* 4.8.2.2.2 Attributes of the PIR configuration attribute set*/
#ifdef __IAR_SYSTEMS_ICC__
#define gZclAttrOccupancySensing_PIROccupiedToUnoccupiedDelay_c     0x0010
#define gZclAttrOccupancySensing_PIRUnoccupiedToOccupiedDelay_c     0x0011
#else
#define gZclAttrOccupancySensing_PIROccupiedToUnoccupiedDelay_c     0x1000
#define gZclAttrOccupancySensing_PIRUnoccupiedToOccupiedDelay_c     0x1100
#endif

#ifdef __IAR_SYSTEMS_ICC__
#define gZclAttrOccupancySensing_UltraSonicOccupiedToUnoccupiedDelay_c   0x0020
#define gZclAttrOccupancySensing_UltraSonicUnoccupiedToOccupiedDelay_c   0x0021
#else
/* 4.8.2.2.3 Attributes of the ultrasonic configuration attribute set */
#define gZclAttrOccupancySensing_UltraSonicOccupiedToUnoccupiedDelay_c   0x2000
#define gZclAttrOccupancySensing_UltraSonicUnoccupiedToOccupiedDelay_c   0x2100
#endif
...
#if gZclClusterOptionals_d
  uint8_t PIROccupiedToUnoccupiedDelay;            /* O - PIR Sensor configuration Occupied to Unoccupied Delay */
  uint8_t PIRUnoccupiedToOccupiedDelay;            /* O - PIR Sensor configuration Unoccupied to Occupied Delay */
  uint8_t UltrasonicOccupiedToUnoccupiedDelay;     /* O - Ultrasonic Sensor configuration Occupied to Unoccupied Delay */
  uint8_t UltrasonicUnoccupiedToOccupiedDelay;     /* O - Ultrasonic Sensor configuration Unoccupied to Occupied Delay */
#endif
