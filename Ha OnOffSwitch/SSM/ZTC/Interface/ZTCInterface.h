...
#define gSPIInterface_d TRUE
  ...
  #error Only one of I2C, SCI, SPI interfaces must be active !!!
#endif
#if (gSPIInterface_d && gSCIInterface_d)
  #error Only one of I2C, SCI, SPI interfaces must be active !!!
#endif
#if (gI2CInterface_d && gSPIInterface_d)
  #error Only one of I2C, SCI, SPI interfaces must be active !!!
#endif


/* Select UART as default interface if none is specified */
#if ((0 == gI2CInterface_d) && (0 == gSCIInterface_d)&&(0 == gSPIInterface_d))
...
#if (gZtcIncluded_d && gCfgSPIInterface_d && (!gSPI_Enabled_d))
