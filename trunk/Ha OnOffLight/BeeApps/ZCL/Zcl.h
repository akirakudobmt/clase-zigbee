...
#define gZclNotAuthorized_c                0x78 /* not authorized */
...
#define gzclEvtHandleGetScheduledPrices_c (1 << 4)
#define gzclEvtHandleClientPrices_c (1 << 5)
#define gzclEvtHandlePublishPriceUpdate_c (1<< 6)
#define gzclEvtHandleGetScheduledLdCtlEvts_c (1 << 7)
