...
enum {
  ...
  mZtcOtaSupportSetInternalFlashReq_c  = 0x28,
  mZtcOtaSupportStartImageReq_c        = 0x29,
  mZtcOtaSupportPushImageChunkReq_c    = 0x2A,
  mZtcOtaSupportCommitImageReq_c       = 0x2B,
  mZtcOtaSupportCancelImageReq_c       = 0x2C,
#endif  
