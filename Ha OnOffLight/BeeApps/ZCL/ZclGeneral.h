...
#if ( TRUE == gBigEndian_c )
#define gZclAttrMainsInformationMainsVoltage_c    0x0000    /* O - Mains Voltage */
#define gZclAttrMainsInformationMainsFrequency_c  0x0100    /* O - Mains Frequency */
#else
#define gZclAttrMainsInformationMainsVoltage_c    0x0000    /* O - Mains Voltage */
#define gZclAttrMainsInformationMainsFrequency_c  0x0001    /* O - Mains Frequency */
#endif /* #if ( TRUE == gBigEndian_c ) */

                                 
/* 3.3.2.2.2 Mains Settings Attributes Set */
#if ( TRUE == gBigEndian_c )
#define gZclAttrMainsSettingsMainsAlarmMask_c             0x1000    /* O - Mains Information attributes Set */
#define gZclAttrMainsSettingsMainsVoltageMinThreshold_c   0x1100    /* O - Mains Settings attributes Set */
#define gZclAttrMainsSettingsMainsVoltageMaxThreshold_c   0x1200    /* O - Battery Information attributes Set */
#define gZclAttrMainsSettingsMainsVoltageDwellTripPoint_c 0x1300    /* O - Battery Settings attributes Set */
#else
#define gZclAttrMainsSettingsMainsAlarmMask_c             0x0010    /* O - Mains Information attributes Set */
#define gZclAttrMainsSettingsMainsVoltageMinThreshold_c   0x0011    /* O - Mains Settings attributes Set */
#define gZclAttrMainsSettingsMainsVoltageMaxThreshold_c   0x0012    /* O - Battery Information attributes Set */
#define gZclAttrMainsSettingsMainsVoltageDwellTripPoint_c 0x0013    /* O - Battery Settings attributes Set */
#endif /* #if ( TRUE == gBigEndian_c ) */
...
#if ( TRUE == gBigEndian_c )
#define gZclAttrBatteryInformationBatteryVoltage_c             0x2000    /* O - Battery Voltage */
#else
#define gZclAttrBatteryInformationBatteryVoltage_c             0x0020    /* O - Battery Voltage */
#endif /* #if ( TRUE == gBigEndian_c ) */


/* 3.3.2.2.4 Battery Settings Attributes Set */
#if ( TRUE == gBigEndian_c )
#define gZclAttrBatterySettingsBatteryManufacturer_c          0x3000    /* O - Battery Manufacturer */
#define gZclAttrBatterySettingsBatterySize_c                  0x3100    /* O - Battery Size */
#define gZclAttrBatterySettingsBatteryAHrRating_c             0x3200    /* O - Battery A/Hr Rating */
#define gZclAttrBatterySettingsBatteryQuantity_c              0x3300    /* O - Battery Quantity */
#define gZclAttrBatterySettingsBatteryRatedVoltage_c          0x3400    /* O - Battery Rated Voltage */
#define gZclAttrBatterySettingsBatteryAlarmMask_c             0x3500    /* O - Battery Alarm Mask */
#define gZclAttrBatterySettingsBatteryVoltageMinThreshold_c   0x3600    /* O - Battery Voltage Min Threshold */
#else
#define gZclAttrBatterySettingsBatteryManufacturer_c          0x0030    /* O - Battery Manufacturer */
#define gZclAttrBatterySettingsBatterySize_c                  0x0031    /* O - Battery Size */
#define gZclAttrBatterySettingsBatteryAHrRating_c             0x0032    /* O - Battery A/Hr Rating */
#define gZclAttrBatterySettingsBatteryQuantity_c              0x0033    /* O - Battery Quantity */
#define gZclAttrBatterySettingsBatteryRatedVoltage_c          0x0034    /* O - Battery Rated Voltage */
#define gZclAttrBatterySettingsBatteryAlarmMask_c             0x0035    /* O - Battery Alarm Mask */
#define gZclAttrBatterySettingsBatteryVoltageMinThreshold_c   0x0036    /* O - Battery Voltage Min Threshold */
#endif /* #if ( TRUE == gBigEndian_c ) */
...
enum
{
   gBatteryAlarmMask_BatteryVoltage2Low = 0,       /* No Battery */
                                                   /* 1 - 7 Reserved */                                    
};
...
enum
{
   gZclAlarmInformation_AlarmCount_c = 0x00,    /* O - Alarm Count */
                                                /* 0x01-0xFF Reserved */
};
...
/* Reset All Alarm Payload */
typedef struct zclAlarmInformation_ResetAllAlarms_tag 
{
   afAddrInfo_t addrInfo;
   uint8_t zclTransactionId;
}zclAlarmInformation_ResetAllAlarms_t; 
...
zbStatus_t Alarms_ResetAllAlarms(zclAlarmInformation_ResetAllAlarms_t *pReq);
//zbStatus_t Alarms_GetAlarm(gZclAlarmTable_t *pReq);
//zbStatus_t Alarms_ResetAlarmLog(gZclAlarmTable_t *pReq);
zbStatus_t Alarms_Alarm(zclAlarmInformation_Alarm_t *pReq);
zbStatus_t Alarms_GetAlarmResponse(zclCmdAlarmInformation_GetAlarmResponse_t *pReq);
/**********************************************************/
